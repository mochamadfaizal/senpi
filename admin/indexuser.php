          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <div class="btn-group" role="group">
              ...
              <ul class="dropdown-menu">
                <li><a href="indexuser.php?page=kategori">Kategori</a></li>
                <li><a href="indexuser.php?page=berita">Berita</a></li>
                <li><a href="indexuser.php?page=profile">Profil</a></li>
              </ul>
            </div>
            </div>
            <!--<li><a href='indexuser.php/dashboard'><?=$nm?></a></li>-->
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class=""><a href='indexuser.php'>Dashboard <span class="sr-only">(current)</span></a></li>
              
              
            <li><a href='indexuser.php?page=kategori'>Kategori</a></li>
            <li><a href='indexuser.php?page=berita'>Berita</a></li>
            <li><a href='indexuser.php?page=profile'>Profile</a></li>
            <li><a href='proses.php?i=logout'>Logout</a></li>
          </ul>
